...
const GroupContribution = ({ contribution, navigation }) => {
  ...
  return (
    <Box>
      <Pressable
        onPress={() => navigation.push(SCREEN_NAME_CONSTANTS.GROUP_CONTRIBUTION_DETAIL_SCREEN, { contributionID: contribution._id })}>
        <Box
          borderRadius={32}
