        ...
        <Box
            ...
            {paymentMethod.type === "bank_account" ? (
                <Box>
                    ...
                    <Text mb={2} fontSize="sm" color="muted.500"
                          fontFamily="body">{paymentMethod.bankAccount.accountHolderName}</Text>
                    <Text mb={2} fontSize="sm" color="muted.500"
                          fontFamily="body">{paymentMethod.bankAccount.accountNumber}</Text>
                ...
                <Box>
                    ...
                    <Icon
                        ...
                        size="sm"
                        as={<Fontisto
                            name={getBrandLogo(paymentMethod.card.brand)} />} />
                    <Text mb={2} color="muted.500" fontSize="sm" fontFamily="body">{paymentMethod.card.brand}</Text>
                    <Text mb={2} color="muted.500" fontSize="sm"
                          fontFamily="body">{paymentMethod.card.cardHolderName}</Text>
                    <Text mb={2} color="muted.500" fontSize="sm"
                          fontFamily="body">{paymentMethod.card.cardNumber}</Text>
