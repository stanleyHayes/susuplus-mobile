...
const Disbursement = ({ disbursement, navigation }) => {
  ...
  return (
    <Box>
      <Pressable
        onPress={() => navigation.push(SCREEN_NAME_CONSTANTS.DISBURSEMENT_DETAIL_SCREEN, { disbursementID: disbursement._id })}>
        <Box
          ...
          <HStack>
            <Box>
              <Image
                alt={disbursement.group.name}
                source={disbursement.group.image}
