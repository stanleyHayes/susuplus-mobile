...
const GroupDetailScreen = ({ navigation, route }) => {
    const { groupLoading, groupError, groupDetail, groupMembers } = useSelector(selectGroups);
    ...
    return (
        <ScrollView>
            <Flex position="relative" height="100%" width="100%" backgroundColor="gray.100">
                {groupLoading &&
                <Center zIndex={1000} width="100%" height="100%">
                    <Spinner
                        position="absolute"
                        size={50}
                    />
                ...
                {groupError && (
                    <Alert p={3} width="100%" status="error" borderRadius={32} variant="left-accent">
                        <VStack alignItems="center" width="100%" space={2}>
                            ...
                            <Text fontSize="md" color="red.600">{groupError}</Text>
                        </VStack>
                    </Alert>
                )}
                {groupDetail && (
                    <Box m={2}>
                        ...
                        <Box p={2} backgroundColor="gray.100">
                            ...
                            <Pressable
                                onPress={() => navigation.push(SCREEN_NAME_CONSTANTS.GROUP_DISBURSEMENTS_SCREEN)}>
                                <Box mt={2} mb={2} shadow={0} borderRadius={32} p={2}
                                     backgroundColor="primary.50">
                                    <HStack>
                                        <Center
                            ...
                            <Pressable
                                onPress={() => navigation.push(SCREEN_NAME_CONSTANTS.GROUP_CONTRIBUTION_DETAIL_SCREEN)}>
                                <Box mt={2} mb={2} shadow={0} borderRadius={32} p={2}
                                     backgroundColor="primary.50">
                                    <HStack>
                                        <Center
                            ...
                            <Pressable
                                onPress={() => navigation.push(SCREEN_NAME_CONSTANTS.GROUP_INVITATIONS_SCREEN, {groupID})}>
                                <Box mt={2} mb={2} shadow={0} borderRadius={32} p={2}
                                     backgroundColor="primary.50">
                                    <HStack>
                                        <Center
