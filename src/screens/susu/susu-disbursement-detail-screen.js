          ...
          {susuDisbursementDetail.payment.method === "BANK" ? (
            <Box>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.bankAccount.bankName}</Text>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.bankAccount.accountBranch}</Text>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.bankAccount.accountName}</Text>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.bankAccount.accountNumber}</Text>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.bankAccount.mobileNumber}</Text>
            </Box>
            ...
            <Box>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.cardDetail.cardHolderName}</Text>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.cardDetail.cardNumber}</Text>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.cardDetail.expiryDate}</Text>
            </Box>
            ...
            <Box>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.mobileMoneyAccount.provider}</Text>
              ...
              <Divider
                ...
                orientation="horizontal"
                thickness={1} />
              <Text fontSize="lg" fontFamily="body">{susuDisbursementDetail.payment.mobileMoneyAccount.number}</Text>
            </Box>
          ) : null}
        </Box>
      </Box>
